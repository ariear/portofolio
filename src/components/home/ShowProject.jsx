const ShowProject = () => {
    return (
        <div className="font-pupylinux container mx-auto px-5 py-20">
            <p className="text-[#3B71FE] font-semibold text-xl mb-4" data-aos="fade-right" data-aos-duration="600" data-aos-delay="200">the project i have made</p>
            <p className="text-[#0E0E2C] font-bold text-3xl md:w-[600px] mb-8" data-aos="fade-right" data-aos-duration="500" data-aos-delay="600">projects built with peat and open source</p>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-y-14 md:gap-x-5 lg:gap-x-9 xl:gap-x-0 justify-items-center">
                ...
                <div data-aos="fade-right" data-aos-duration="600" data-aos-delay="300">
                    ...
                    <p className="text-[#3B71FE] font-bold text-lg">Go Blog</p>
                </div>
