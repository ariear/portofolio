...
const Services = () => {
    return (
        <div className="font-pupylinux container mx-auto px-5 md:px-8 xl:px-5 py-24">
            <p className="font-semibold text-xl text-[#3B71FE] mb-4">The Services We Offers</p>
            <div className="grid md:grid-cols-3 lg:grid-cols-4 md:gap-x-9 xl:gap-x-24 gap-y-16">
                <div className="text-[#0E0E2C] font-bold text-[27px] xl:text-[34px] md:col-span-3 lg:col-span-2">
