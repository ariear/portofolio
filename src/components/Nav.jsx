...
const Nav = () => {
    ...
    return (
        ...
        <div className={open ? 'h-[210px] border-b lg:hidden font-pupylinux font-medium px-4 pt-5 sticky top-[84px] bg-white z-40 transition-all overflow-hidden' : 'h-0 border-b lg:hidden px-4 sticky top-[84px] bg-white z-40 transition-all overflow-hidden'}>
